...
!function(){function e(){$("#submitButton").click(n)}function n(e){e.preventDefault();var n=$("#error-messages"),t={};t.name=$("#name").val(),t.email=$("#email").val(),t.message=$("#message").val(),$.post({url:"/mail",contentType:"application/json",data:JSON.stringify(t),success:function(e){e&&n.text(e.error)}}).fail(function(){console.log("jquery post error")})}$(document).ready(e)}();
