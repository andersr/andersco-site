...
!function(e){"use strict";function a(a,s){e.post({url:s.url,contentType:"application/json",data:JSON.stringify(a),success:function(e){e&&n(e)}}).fail(function(){console.log("post data error")})}function n(e){for(var a=0;a<e.length;a++)t[e[a]].after(i.errors[e[a]])}function s(e){e.preventDefault();var n={name:t.name.val(),email:t.email.val(),message:t.message.val()},s={url:"/mail"};a(n,s)}var t,i={errors:{name:"Please enter a name",email:"Please enter a valid email",message:"Please enter a message"}};e(function(){t={name:e("#name"),email:e("#email"),message:e("#message"),submit:e("#submitButton")},t.submit.on("click",s)})}(jQuery);
