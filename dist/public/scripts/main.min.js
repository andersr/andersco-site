...
!function(e){"use strict";function a(a,n,t){e.post({url:n.url,contentType:"application/json",data:JSON.stringify(a),success:function(e){t(e)}}).fail(function(){console.log("post data error")})}function n(e){for(var a=0;a<e.length;a++)r[e[a]].after(s.errors[e[a]])}function t(e){e.preventDefault();var t={name:r.name.val(),email:r.email.val(),message:r.message.val()},o={url:"/mail"};a(t,o,function(e){e.errors.length>0?n(e.errors):(r.name.val(""),r.email.val(""),r.message.val(""),r.alerts.text(s.confirmation),setTimeout(function(){r.alerts.empty()},5e3))})}var r,s={errors:{name:"Please enter a name",email:"Please enter a valid email",message:"Please enter a message"},confirmation:"Thank you for contacting me!"};e(function(){r={form:e("#contactForm"),name:e("#name"),email:e("#email"),message:e("#message"),submit:e("#submitButton"),alerts:e("#alerts")},r.submit.on("click",t)})}(jQuery);
