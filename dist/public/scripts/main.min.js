...
!function(){$(function(){"use strict";function e(e){return"."+e+"-error"}function n(e){return utils.isEmpty($(e).val())}function a(e){return!utils.isEmail($(e).val())}function t(){u[this.name].wasInvalid&&(("email"!==this.name||a(this))&&n(this)||$(e(this.name)).hide())}function r(){("email"===this.name&&a(this)||n(this))&&(u[this.name].wasInvalid=!0,i(this))}function i(n){$(e(n.name)).text(c.errors[n.name]).show()}function o(e,n,a){$.post({url:n.url,contentType:"application/json",data:JSON.stringify(e),success:function(e){a(e)}}).fail(function(){console.log("post data error")})}function s(e){for(var n=0;n<e.length;n++)u[e[n]].error.text(c.errors[e[n]]).show()}function l(){$.each([u.name.el,u.email.el,u.message.el,u.honeypot.el],function(e,n){n.val("")})}function m(e){e.preventDefault();var n={name:u.name.el.val(),email:u.email.el.val(),message:u.message.el.val(),honeypot:u.honeypot.el.val()},a={url:"/mail"};o(n,a,function(e){e.errors.length>0?s(e.errors):(l(),u.alerts.text(c.confirmation),setTimeout(function(){u.alerts.empty()},5e3))})}var u={form:$("#contactForm"),name:{el:$("#name"),error:$(".name-error"),wasInvalid:!1},email:{el:$("#email"),error:$(".email-error"),wasInvalid:!1},message:{el:$("#message"),error:$(".message-error"),wasInvalid:!1},honeypot:{el:$("#mainEmail")},submit:$("#submitButton"),alerts:$("#alerts")},c={errors:{name:"Please enter a name",email:"Please enter a valid email",message:"Please enter a message"},confirmation:"Thank you for contacting me!"};u.submit.on("click",m),$.each([u.name.el,u.email.el,u.message.el],function(e,n){n.on("blur",r),n.on("keyup",t)})})}();
