...
!function(e){"use strict";function t(e,t){for(var s in t)t.hasOwnProperty(s)&&(e[s]=t[s]);return e}function s(e,t){for(var s=0;s<e.length;s++){var i=e[s];t(i)}}function i(e){this.options=t({},this.options),t(this.options,e),this._init()}i.prototype.options={wrapper:"#o-wrapper",type:"slide-left",menuOpenerClass:".c-button",maskClass:".mask"},i.prototype._init=function(){this.body=document.body,this.wrapper=document.querySelector(this.options.wrapper),this.mask=document.querySelector(this.options.maskClass),this.menu=document.querySelector("#c-menu--"+this.options.type),this.closeMenu=this.menu.querySelectorAll(".c-menu__close"),this.menuOpeners=document.querySelectorAll(this.options.menuOpenerClass),this._initEvents()},i.prototype._initEvents=function(){for(var e=0;e<this.closeMenu.length;e++)this.closeMenu[e].addEventListener("click",function(e){this.close()}.bind(this));this.mask.addEventListener("click",function(e){e.preventDefault(),this.close()}.bind(this))},i.prototype.open=function(){this.body.classList.add("has-active-menu"),this.wrapper.classList.add("has-"+this.options.type),this.menu.classList.add("is-active"),this.menu.classList.add("c-menu__close"),this.mask.classList.add("is-active"),this.disableMenuOpeners()},i.prototype.close=function(){this.body.classList.remove("has-active-menu"),this.wrapper.classList.remove("has-"+this.options.type),this.menu.classList.remove("is-active"),this.mask.classList.remove("is-active"),this.enableMenuOpeners()},i.prototype.disableMenuOpeners=function(){s(this.menuOpeners,function(e){e.disabled=!0})},i.prototype.enableMenuOpeners=function(){s(this.menuOpeners,function(e){e.disabled=!1})},e.Menu=i}(window);
...
!function(){function e(){var e=0,t=$('.handle-disable-submit input[type="submit"], .handle-disable-submit button[type="submit"]'),i=function(e){return 0===e.val().trim().length};$(".required_field").each(function(){e+=1,i($(this))?t.attr("disabled","disabled"):t.removeAttr("disabled")}),$(".required_field").keyup(function(){var d=0;$(".required_field").each(function(){i($(this))||(d+=1),d===e?t.removeAttr("disabled"):t.attr("disabled","disabled")})})}$(document).ready(e)}();
!function(){$(function(){"use strict";function e(e){return"."+e+"-error"}function a(){o[this.name].wasInvalid&&$(this).val().trim().length>0&&$(e(this.name)).hide()}function n(){"email"===this.name?t(this):r(this)}function r(a){var n=utils.isEmpty($(a).val());n&&(o[a.name].wasInvalid=!0,$(e(a.name)).text(m.errors[a.name]).show())}function t(a){var n=utils.isEmail($(a).val());n||(o[a.name].wasInvalid=!0,$(e(a.name)).text(m.errors[a.name]).show())}function s(e,a,n){$.post({url:a.url,contentType:"application/json",data:JSON.stringify(e),success:function(e){n(e)}}).fail(function(){console.log("post data error")})}function i(e){for(var a=0;a<e.length;a++)o[e[a]].error.text(m.errors[e[a]]).show()}function l(e){e.preventDefault();var a={name:o.name.el.val(),email:o.email.el.val(),message:o.message.el.val()},n={url:"/mail"};s(a,n,function(e){e.errors.length>0?i(e.errors):(o.name.el.val(""),o.email.el.val(""),o.message.el.val(""),o.alerts.text(m.confirmation),setTimeout(function(){o.alerts.empty()},5e3))})}var o={form:$("#contactForm"),name:{el:$("#name"),error:$(".name-error"),wasInvalid:!1},email:{el:$("#email"),error:$(".email-error"),wasInvalid:!1},message:{el:$("#message"),error:$(".message-error"),wasInvalid:!1},submit:$("#submitButton"),alerts:$("#alerts")},m={errors:{name:"Please enter a name",email:"Please enter a valid email",message:"Please enter a message"},confirmation:"Thank you for contacting me!"};o.submit.on("click",l),$.each([o.name.el,o.email.el,o.message.el],function(e,r){r.on("blur",n),r.on("keyup",a)})})}();
$(function(){"use strict";function e(e){for(var t,c=e.coded.length,d="",n=0;n<e.coded.length;n++)e.key.indexOf(e.coded.charAt(n))===-1?(t=e.coded.charAt(n),d+=t):(t=(e.key.indexOf(e.coded.charAt(n))-c+e.key.length)%e.key.length,d+=e.key.charAt(t));return d}function t(t){var c=e(t),d=t.linkText||c,n=$(t.id),o="mailto:"+c;n.attr("href",o).text(d)}const c={id:"#andersco-mailto",coded:"ca@XrLnqI.pN",key:"wmS20BDlarV8QdAMbC1jXqUgHLzhfvRts7KG3ZWcx5EoIOkeP4Tp6FuNYJin9y"};t(c)});
