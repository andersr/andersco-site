...
$(function(){"use strict";function e(e){d.text(e),c.show()}function a(e){return"."+e+"-error"}function n(e){return utils.isEmpty($(e).val())}function t(e){return!utils.isEmail($(e).val())}function i(){f[this.name].wasInvalid&&(("email"!==this.name||t(this))&&n(this)||$(a(this.name)).hide())}function s(e){("email"===this.name&&t(this)||n(this))&&(f[this.name].wasInvalid=!0,r(this))}function r(e){$(a(e.name)).text(h.errors[e.name]).show()}function l(e,a,n){$.post({url:a.url,contentType:"application/json",data:JSON.stringify(e),success:function(e){n(e)}}).fail(function(){n({messageSent:!1})})}function o(e){for(var a=0;a<e.length;a++)f[e[a]].error.text(h.errors[e[a]]).show()}function m(e){$.each([f.name,f.email,f.message,f.honeypot],function(e,a){a.el.val(""),a.wasInvalid&&(a.wasInvalid=!1)}),e()}function u(a){a.preventDefault(),f.submit.attr("disabled","disabled").text("Sending...");var n={name:f.name.el.val(),email:f.email.el.val(),message:f.message.el.val(),honeypot:f.honeypot.el.val()},t={url:"/mail"};l(n,t,function(a){a.messageSent===!1?(e(h.sendError),f.submit.removeAttr("disabled","disabled").text("Send")):a.errors.length>0?(o(a.errors),f.submit.text("Send")):m(function(){f.submit.attr("disabled","disabled").text("Send"),e(h.confirmation)})})}var c=$("#alert"),d=c.find(".message"),f={form:$("#contactForm"),name:{el:$("#name"),error:$(".name-error"),wasInvalid:!1},email:{el:$("#email"),error:$(".email-error"),wasInvalid:!1},message:{el:$("#message"),error:$(".message-error"),wasInvalid:!1},honeypot:{el:$("#mainEmail")},submit:$("#submitButton"),alerts:$("#alerts")},h={errors:{name:"Please enter a name.",email:"Please enter a valid email.",message:"Please enter a message."},confirmation:"Thank you for contacting me!",sendError:"Sorry, there was a problem sending this message. Try again?"};f.submit.on("click",u),$.each([f.name.el,f.email.el,f.message.el],function(e,a){a.on("blur",s),a.on("keyup",i)})});
