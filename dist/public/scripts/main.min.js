...
!function(e,n,s){function t(e,n){return typeof e===n}function a(){var e,n,s,a,o,r,c;for(var u in l)if(l.hasOwnProperty(u)){if(e=[],n=l[u],n.name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(s=0;s<n.options.aliases.length;s++)e.push(n.options.aliases[s].toLowerCase());for(a=t(n.fn,"function")?n.fn():n.fn,o=0;o<e.length;o++)r=e[o],c=r.split("."),1===c.length?f[c[0]]=a:(!f[c[0]]||f[c[0]]instanceof Boolean||(f[c[0]]=new Boolean(f[c[0]])),f[c[0]][c[1]]=a),i.push((a?"":"no-")+c.join("-"))}}function o(e){var n=u.className,s=f._config.classPrefix||"";if(d&&(n=n.baseVal),f._config.enableJSClass){var t=new RegExp("(^|\\s)"+s+"no-js(\\s|$)");n=n.replace(t,"$1"+s+"js$2")}f._config.enableClasses&&(n+=" "+s+e.join(" "+s),d?u.className.baseVal=n:u.className=n)}function r(){return"function"!=typeof n.createElement?n.createElement(arguments[0]):d?n.createElementNS.call(n,"http://www.w3.org/2000/svg",arguments[0]):n.createElement.apply(n,arguments)}var i=[],l=[],c={_version:"3.3.1",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var s=this;setTimeout(function(){n(s[e])},0)},addTest:function(e,n,s){l.push({name:e,fn:n,options:s})},addAsyncTest:function(e){l.push({name:null,fn:e})}},f=function(){};f.prototype=c,f=new f;var u=n.documentElement,d="svg"===u.nodeName.toLowerCase();f.addTest("rgba",function(){var e=r("a").style;return e.cssText="background-color:rgba(150,255,150,.5)",(""+e.backgroundColor).indexOf("rgba")>-1}),f.addTest("cssremunit",function(){var e=r("a").style;try{e.fontSize="3rem"}catch(e){}return/rem/.test(e.fontSize)}),a(),o(i),delete c.addTest,delete c.addAsyncTest;for(var p=0;p<f._q.length;p++)f._q[p]();e.Modernizr=f}(window,document);
...
!function(){$(function(){"use strict";function e(e){return"."+e+"-error"}function a(e){return utils.isEmpty($(e).val())}function n(e){return!utils.isEmail($(e).val())}function t(){c[this.name].wasInvalid&&(("email"!==this.name||n(this))&&a(this)||$(e(this.name)).hide())}function i(){("email"===this.name&&n(this)||a(this))&&(c[this.name].wasInvalid=!0,r(this))}function r(a){$(e(a.name)).text(f.errors[a.name]).show()}function s(e,a,n){$.post({url:a.url,contentType:"application/json",data:JSON.stringify(e),success:function(e){n(e)}}).fail(function(){console.log("post data error")})}function o(e){for(var a=0;a<e.length;a++)c[e[a]].error.text(f.errors[e[a]]).show()}function l(){c.submit.attr("disabled","disabled")}function m(e){$.each([c.name,c.email,c.message,c.honeypot],function(e,a){a.el.val(""),a.wasInvalid&&(a.wasInvalid=!1)}),e()}function u(e){e.preventDefault();var a={name:c.name.el.val(),email:c.email.el.val(),message:c.message.el.val(),honeypot:c.honeypot.el.val()},n={url:"/mail"};s(a,n,function(e){e.errors.length>0?o(e.errors):(m(l),c.alerts.fadeIn("slow").text(f.confirmation),setTimeout(function(){c.alerts.fadeOut("slow")},5e3))})}var c={form:$("#contactForm"),name:{el:$("#name"),error:$(".name-error"),wasInvalid:!1},email:{el:$("#email"),error:$(".email-error"),wasInvalid:!1},message:{el:$("#message"),error:$(".message-error"),wasInvalid:!1},honeypot:{el:$("#mainEmail")},submit:$("#submitButton"),alerts:$("#alerts")},f={errors:{name:"Please enter a name",email:"Please enter a valid email",message:"Please enter a message"},confirmation:"Thank you for contacting me!"};c.submit.on("click",u),$.each([c.name.el,c.email.el,c.message.el],function(e,a){a.on("blur",i),a.on("keyup",t)})})}();
!function(){$(function(){"use strict";var o=$(".navbar"),n=$(".header-nav"),t=$(".top-content"),w=$("#welcome-nav"),d=o.outerHeight(),e=$(window).width(),i=640;$(window).resize(function(){e=$(window).width(),e>i?n.show():n.hide()}),$(window).scroll(function(){var s=$(window).scrollTop(),a=t.offset().top-s,r=w.offset().top-s+25;a<d?o.addClass("drop-shadow"):o.removeClass("drop-shadow"),r<d&&e>i?n.show():n.hide()})})}();
